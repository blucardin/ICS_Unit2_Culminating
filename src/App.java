...
class snake {
  ...
  public static void menu() throws InterruptedException, IOException{
    ...
    while (menu) {
      //loop over array
      for (int q = 0; q < 14; q++) { //for each frame in the animation, flush the screen, print it, and wait for 125 milliseconds
        System.out.print("\033[H\033[2J");
        System.out.flush();
        System.out.println("Welcome, " + username + "!");
        ...
        int[][] blocks = {{7, 7}, {7, 8}, {7, 9}, {7, 10}, {7, 11}, {7, 12}, {7, 13}, {7, 14}, {7, 15},
